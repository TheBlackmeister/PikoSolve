function darkmodefunc() {
    ...
    btn.addEventListener("click", function () {
        ...
        if (theme.getAttribute("href") === "css/styles_myprofile.css") { // TAHLE ZJISTUJE JAKA JE PROMENNA
            theme.href = "css/styles_myprofile_dark.css";
            swapStylesheet('yes')
        } else {
            theme.href = "css/styles_myprofile.css";
            swapStylesheet('no')
        }
    });
}
